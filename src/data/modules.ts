...
export const MODULES: TeachingModule[] = [
  ...
  { id: "hs-v1-g7", title: "Cultural Heritage of Bamboo Music", level: "High School", volume: 1, grade: "Grade 7", authors: ["Mangahas, V. C."], year: 2023, pdfUrl: "https://www.africau.edu/images/default/sample.pdf", thumbnailPrompt: "high school bamboo heritage cover", description: "Historical context and regional traditions of Philippine bamboo music." },
  { id: "hs-v1-g9", title: "Acoustics of Bamboo Instruments", level: "High School", volume: 1, grade: "Grade 9", authors: ["Tan, E. R.", "Bautista, F. A."], year: 2023, pdfUrl: "https://www.africau.edu/images/default/sample.pdf", thumbnailPrompt: "acoustics bamboo module", description: "Introductory acoustics applied to bamboo aerophones and idiophones." },
  { id: "hs-v2-g8", title: "Making Your First Bamboo Flute", level: "High School", volume: 2, grade: "Grade 8", authors: ["Villanueva, K. J."], year: 2024, pdfUrl: "https://www.africau.edu/images/default/sample.pdf", thumbnailPrompt: "making bamboo flute workshop", description: "Workshop module on selecting bamboo and constructing a simple flute." },
  { id: "hs-v2-g10", title: "Ensemble Performance with Bamboo Instruments", level: "High School", volume: 2, grade: "Grade 10", authors: ["Aquino, D. R.", "Pascual, M. E."], year: 2024, pdfUrl: "https://www.africau.edu/images/default/sample.pdf", thumbnailPrompt: "bamboo ensemble performance cover", description: "Arranging and conducting a bamboo instrument ensemble." },
];
